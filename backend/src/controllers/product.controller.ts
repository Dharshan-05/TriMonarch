...
export class ProductController {
  create = async (req: Request, res: Response): Promise<void> => {
    ...
    const prod = await productService.createProduct({ ...req.body, organization_id: orgId });
  ...
  getById = async (req: Request, res: Response): Promise<void> => {
    ...
    const prod = await productService.getProductById(orgId, req.params.id!);
    const response: ApiResponse<typeof prod> = {
      success: true,
      data: prod,
      meta: { requestId: req.id },
  ...
  update = async (req: Request, res: Response): Promise<void> => {
    const orgId = getOrganizationId(req);
    const updated = await productService.updateProduct(orgId, req.params.id!, req.body);
